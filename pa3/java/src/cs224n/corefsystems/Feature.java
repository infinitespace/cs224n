...
public interface Feature {
  ...
  public static class ExactHeadWordMatch extends Indicator {
    public ExactHeadWordMatch (boolean exactHeadWordMatch) { super(exactHeadWordMatch); }
  }
  ...
  public static class PronounGenderMatch extends Indicator {
    public PronounGenderMatch (boolean genderMatch) { super(genderMatch); }
  }

  public static class PronounSpeakerMatch extends Indicator {
    public PronounSpeakerMatch (boolean speakerMatch) { super(speakerMatch); }
  }

  public static class PronounTypeMatch extends Indicator {
    public PronounTypeMatch (boolean typeMatch) { super(typeMatch); }
  }

  public static class PronounPluralMatch extends Indicator {
    public PronounPluralMatch (boolean pluralMatch) { super(pluralMatch); }
  }

  public static class DistanceMention extends IntIndicator {
    public DistanceMention (int distanceMention) { super(distanceMention); }
  }

  public static class DistanceSentence extends IntIndicator {
    public DistanceSentence (int distanceSentence) { super(distanceSentence); }
  }
